<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wamp64\www\sdb/application/admin\view\guestbook\index.html";i:1496980063;s:59:"D:\wamp64\www\sdb/application/admin\view\public\header.html";i:1498266664;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="__ROOT__/index.php/guestbook/add.html" target="_blank"><i class="icon-font"></i>前台在线留言</a>
                        <a href="__ROOT__/index.php/guestbook/lists.html" target="_blank"><i class="icon-font"></i>前台留言列表</a>
                        <a onclick="myform.action='<?php echo url('Guestbook/delete'); ?>';myform.submit();" href="javascript:void(0)"><i class="icon-font"></i>批量删除</a>
                        <a onClick="confirm_delete()" href="<?php echo url('Guestbook/delete_all'); ?>"><i class="icon-font"></i>删除所有留言</a>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wamp64\www\sdb/application/admin\view\infomation\index.html";i:1498284938;s:59:"D:\wamp64\www\sdb/application/admin\view\public\header.html";i:1498266664;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">资讯管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo url('Infomation/index'); ?>" method="get">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo url('Infomation/add'); ?>"><i class="icon-font"></i>添加资讯</a>
                        <a onclick="myform.action='<?php echo url('Infomation/delete'); ?>';myform.submit();" href="javascript:void(0)"><i class="icon-font"></i>批量删除</a>
                        <a onclick="myform.action='<?php echo url('Infomation/listorder'); ?>';myform.submit();" href="javascript:void(0)"><i class="icon-font"></i>更新排序</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr align="center">
                            ...
                            <td>
                               <input class="common-input sort-input" name="sort[<?php echo $vo['id']; ?>]" value="<?php echo $vo['sort']; ?>" type="text">
                            </td>
                             <td><?php echo $vo['type']; ?></td>
                             <td><?php echo $vo['nickname']; ?></td>
                            <td align="left"><a target="_blank" href="__ROOT__/index.php/Infomation/show.html?id=<?php echo $vo['id']; ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a>
                            </td>
                           
                            <td><?php echo date("Y-m-d",$vo['addtime']); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo url('Infomation/edit',['id'=>$vo['id']]); ?>">修改</a>
                                <a class="link-del" href="<?php echo url('Infomation/delete',['id'=>$vo['id']]); ?>">删除</a>
                            </td>
                        </tr>

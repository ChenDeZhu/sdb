<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\wamp64\www\sdb/application/admin\view\recruitment\index.html";i:1498273655;s:59:"D:\wamp64\www\sdb/application/admin\view\public\header.html";i:1498266664;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">招聘管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo url('recruitment/index'); ?>" method="get">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo url('recruitment/add'); ?>"><i class="icon-font"></i>添加招聘</a>
                        
                        <a onclick="myform.action='<?php echo url('recruitment/listorder'); ?>';myform.submit();" href="javascript:void(0)"><i class="icon-font"></i>更新排序</a> 
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr align="center">
                            ...
                            <td align="left"><a target="_blank" href="__ROOT__/index.php/recruitment/show.html?id=<?php echo $vo['id']; ?>" title="<?php echo $vo['position']; ?>"><?php echo $vo['position']; ?></a>
                            </td>
                            <td><?php echo $vo['salary']; ?></td>
                            <td>
                                <a class="link-update" href="<?php echo url('recruitment/edit',['id'=>$vo['id']]); ?>">修改</a>
                                <a class="link-del" href="<?php echo url('recruitment/delete',['id'=>$vo['id']]); ?>">删除</a>
                            </td>
                        </tr>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\wamp64\www\sdb/application/admin\view\user\index.html";i:1498293756;s:59:"D:\wamp64\www\sdb/application/admin\view\public\header.html";i:1498266664;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr align="center">
                            ...
                            <td><?php echo $vo['mobile_status']; ?></td>
                            <td><?php echo $vo['id_status']; ?></td>
                            <td><?php echo $vo['email_status']; ?></td>
                            <td>
                                <a class="link-update" href="<?php echo url('User/user_detail',['id'=>$vo['uid']]); ?>">查看用户详情</a>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\wamp64\www\sdb/application/admin\view\question\index.html";i:1498291644;s:59:"D:\wamp64\www\sdb/application/admin\view\public\header.html";i:1498266664;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">客服管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo url('Question/index'); ?>" method="get">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a onclick="myform.action='<?php echo url('Question/delete'); ?>';myform.submit();" href="javascript:void(0)"><i class="icon-font"></i>批量删除</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr align="center">
                            ...
                            <td align="left"><a target="_blank" href="__ROOT__/index.php/Question/show.html?id=<?php echo $vo['id']; ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a>
                            </td>
                           
                            <td><?php echo date("Y-m-d",$vo['addtime']); ?></td>
                            <td><?php echo $vo['status']; ?></td>
                            <td>
                                <a class="link-update" href="<?php echo url('Question/edit',['id'=>$vo['id']]); ?>">回复</a>
                                <a class="link-del" href="<?php echo url('Question/delete',['id'=>$vo['id']]); ?>">删除</a>
                            </td>
                        </tr>
